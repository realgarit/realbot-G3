...
from modules.items.berry_trees import get_berry_tree_by_id
from modules.core.context import context
from modules.game.game import decode_string, get_event_flag_name, get_event_var_name
from modules.items.items import get_item_by_name, Item, get_item_by_index
...
from modules.pokemon.pokemon_party import get_current_repel_level, get_party, Pokemon
...
from modules.map.map_constants import MAP_TYPES, WEATHER_TYPES, WEATHER_SCRIPTS
from modules.map.map_tile_names import get_tile_type_name as _get_tile_type_name
...
def get_map_data(
    ...
    if len(_map_header_cache[context.rom.id]) == 0:
        from modules.map.map_data import MapGroupFRLG, MapGroupRSE, MapRSE
