...
from modules.game.memory import pack_uint32, read_symbol, unpack_uint32, unpack_uint16
from modules.pokemon.pokemon_constants import (
    HIDDEN_POWER_MAP,
    LOCATION_MAP,
...
def get_opponent() -> Pokemon | None:
    ...
    """
    from modules.pokemon.pokemon_party import get_opponent_party
