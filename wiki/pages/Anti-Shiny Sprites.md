...
**Anti-shinies are a concept we picked up from the [pokebot-gen3](https://github.com/40Cakes/pokebot-gen3) project.**

Think of them as the complete opposite of a shiny. While a normal shiny has a value between `0` and `7`, an anti-shiny has a value between `65,528` and `65,535`. It's just the 8 highest possible values instead of the 8 lowest.

We made these sprites by running a script that inverts the regular shiny colors.
